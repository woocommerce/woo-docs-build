...
`payment_method_name` is the value of the [name](../checkout-payment-methods/payment-method-integration.md) property used when the payment method was registered with WooCommerce Blocks.
